...
TARGET_PREBUILT_KERNEL := device/samsung/gts28lte/zImage
TARGET_PREBUILT_DTB := device/samsung/gts28lte/dtb.img
...
BOARD_CUSTOM_BOOTIMG_MK :=  device/samsung/gts28lte/bootimg.mk
...
TARGET_INIT_VENDOR_LIB := libinit_gts28lte
TARGET_RECOVERY_DEVICE_MODULES := libinit_gts28lte
TARGET_LIBINIT_DEFINES_FILE := device/samsung/gts28lte/init/init_gts28lte.cpp
